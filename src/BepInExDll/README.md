...
Typical source: your game folder’s `BepInEx/core/` (and any other paths that contain the DLL names listed in `SuperMarketStockTakeAPI.csproj` under `BepInExDll\…`).
